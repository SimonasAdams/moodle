...
$openbanksrenderable = new \core_question\output\question_bank_list($openbanksgenerator);
$openbanks = $openbanksrenderable->export_for_template($output);
$closedbanksrenderable = new \core_question\output\question_bank_list($closedbanksgenerator);
