...
class view_banks implements \templatable, \renderable {
    ...
    public function __construct(
        private readonly array $sharedbanks,
        private readonly array $privatebanks,
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $customqbankmods = array_filter(question_bank_helper::get_activity_types_with_shareable_questions(), static fn($plugin) => $plugin !== 'qbank');
